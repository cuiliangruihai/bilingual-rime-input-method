...
enum class candidate_display_t { chinese_and_english, chinese_only,
                                 english_only };
FCITX_CONFIG_ENUM_NAME_WITH_I18N(candidate_display_t,
                                 N_("Chinese and English"),
                                 N_("Chinese only"), N_("English only"))
...
FCITX_CONFIGURATION(
    ...
    OptionWithAnnotation<candidate_window::candidate_display_t,
                         candidate_window::candidate_display_tI18NAnnotation>
        candidateDisplay{this, "CandidateDisplay", _("Candidate display"),
                         candidate_window::candidate_display_t::chinese_and_english};
